  ...
  return (
    <section id="why-us" className="py-20 bg-white font-sans text-slate-900 border-t border-slate-200">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        {/* Title with Red Underline (Matching Image 2 "WHY CHOOSE US?" section) */}
        ...
        <p className="text-slate-700 text-base sm:text-lg leading-relaxed max-w-3xl mx-auto mb-8 font-normal">
          DomBathroomsLTD is a trusted bathroom refurbishment specialist delivering complete transformations across London and Essex. We handle everything from stripping out old suites to high-end tiling and luxury sanitaryware fitting.
        </p>

        {/* 6 Green Checkmark Grid (Image 1 bullet list) */}
        ...
        {/* Red Button (Matching Image 2 red button) */}
        <div>
          <button
            onClick={onOpenQuote}
